  ...
  return (
    <div className="descriptionbox">
      <div className="descriptionbox_navigator">
        ...
        <div className="description_nav_box fade">Reviews(122)</div>
      </div>
      <div className="descriptionbox_description">
        <p>
          An e-commerce website is an online platform that facilitates the
          buying and selling of products or services over the internet. It
          serves as a virtual marketplace where businesses and showcase their
          products, interact with customers and conduct transactions without the
          need for a ohysical presence.E-commerce websites have gained immense
        ...
        <p>
          ...
          (e.g.sizes colors). Each product ususally has its own dedicated page
